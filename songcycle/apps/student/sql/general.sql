...
--UserSample
insert into public.student_applicationuser(id, email, first_name, last_name, authority, active, first_login_date_timestamp, last_login_date_timestamp, login_count, comment) values (1, 'xxxxx', '', '', '00101', '01', current_timestamp, current_timestamp, 0, 'comment');
